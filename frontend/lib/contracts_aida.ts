...
export const MOONBAGS_AIDA_CONTRACT_V2: MoonbagsContract = {
  ...
  packageId:     '0x0e8e217d4e4f128bad2ffe2feca6f81ab4b2ef8a7a698b991bfd3fe3b036d6e7',
  module:        'moonbags',
...
export const AIDA_PAIR_PACKAGE_IDS: readonly string[] = [
  ...
  '0x0e8e217d4e4f128bad2ffe2feca6f81ab4b2ef8a7a698b991bfd3fe3b036d6e7', // 2026-04-23 re-upgrade of v2 (version 5, adds init_cetus_aida_pool_v2)
