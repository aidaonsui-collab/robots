...
// NOTE: this modal is currently not wired into any page (slug page has its
// own inline trade panel). It targets the legacy 3-arg `buy`/`sell`
// signature which only exists on the v7 upgrade chain. v11 pools need the
// 6-arg `buy_exact_in_with_lock` variant.
import { MOONBAGS_CONTRACT_LEGACY, QUOTE_COIN } from '@/lib/contracts'
