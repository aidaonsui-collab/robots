...
interface TokenType {
  ...
  volume1h: number         // SUI traded in last 1h
  marketCap: number
...
function CopyCA({ coinType }: { coinType?: string }) {
  ...
  // Show just the short address portion e.g. "0x57ac...TEMPLATE"
  ...
  return (
    <div onClick={onClick} className="relative cursor-pointer mb-8 fade-in">
      <div className="absolute -top-3 left-1/2 -translate-x-1/2 z-10">
        <span className="bg-[#D4AF37] text-black text-xs font-bold px-4 py-1 rounded-full shadow-lg shadow-[#D4AF37]/30">
          ✨ SPOTLIGHT
        </span>
      </div>

      <div className="relative rounded-2xl p-[2px] bg-[#D4AF37] shadow-xl shadow-[#D4AF37]/30">
        <div className="bg-[#0f0f17] rounded-2xl p-5">
          ...
          <div className="grid grid-cols-3 gap-3 mb-4">
            <div className="bg-[#14142a] rounded-xl p-3 border border-[#D4AF37]/10">
            ...
            <div className="bg-[#14142a] rounded-xl p-3 border border-[#D4AF37]/10">
              ...
              <p className="text-lg font-bold text-white">{formatVolume(token.volume1h)} <span className="text-xs text-gray-500 font-normal">SUI</span></p>
            </div>
            <div className="bg-[#14142a] rounded-xl p-3 border border-[#D4AF37]/10">
    ...
    >
      ...
      <div className="flex items-start justify-between mb-2.5">
        <div className="flex items-center gap-3 flex-1 min-w-0">
          <div className="relative flex-shrink-0">
            ...
            {hasLiveStream(token) && (
              <span className="absolute -top-0.5 -right-0.5 w-3.5 h-3.5 bg-red-500 border-2 border-[#0f0f17] rounded-full pulse-dot" />
            )}
          </div>
      ...
      <div className="grid grid-cols-3 gap-1.5 mb-3">
        ...
        <div className="bg-[#14142a] rounded-lg p-2 border border-white/5">
          ...
          <p className="text-sm font-bold text-white tabular-nums">{formatVolume(token.volume1h)}<span className="text-[9px] text-gray-600 ml-0.5">SUI</span></p>
        </div>
        {/* Market cap */}
        <div className="bg-[#14142a] rounded-lg p-2 border border-white/5">
