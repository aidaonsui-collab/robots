...
const AIDA_PAIR_CFG_TO_PKG: Record<string, string> = {
  // V2 — 2026-04-21 republish, re-upgraded 2026-04-23 to version 5
  // (0x23e75441…) which ships init_cetus_aida_pool_v2 taking Configuration.
  // Move calls must target the latest upgraded package; events still match
